 ...
 *
 * The core payment modal calls process(). For a redirect based gateway like
 * Konnect we simply send the browser to our server side initiator (pay.php),
 * which creates the Konnect payment and redirects on to the Konnect pay page.
 * The returned promise never resolves because the page is navigating away.
 *
 * @module     paygw_konnect/gateway_modal
